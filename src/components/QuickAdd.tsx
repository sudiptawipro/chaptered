...
import { Plus, X, BookOpen, MessageCircleQuestion, GraduationCap } from 'lucide-react';
...
export default function QuickAdd() {
  ...
  const [mode, setMode] = useState<'menu' | 'hw' | 'doubt' | 'exam'>('menu');
        ...
        >
          ...
          <div className="flex items-center justify-between px-5 pt-5 pb-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
            <h3 className="font-bold text-white text-base">
              {mode === 'menu' ? '⚡ Quick Add' : mode === 'hw' ? '📚 Add Homework' : mode === 'doubt' ? '💬 Log Doubt' : '🎯 Add Exam'}
            </h3>
            {mode !== 'menu' ? (
